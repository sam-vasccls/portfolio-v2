export function useScript(cookie: boolean) {
    ...
    const script = [
        { prefix: "$", type: "type", text: "git clone portfolio-repo" },
        ...
        { prefix: "$", type: "type", text: "npm install" },
        ...
        { prefix: "$", type: "type", text: "npm run dev" },
        ...
        { prefix: ">", type: "output", text: cookie ? "It's gone now... 👀" : "I should hire this guy! 👀", duration: SHORT_LINE_TIMER, color: 'text-success' },
